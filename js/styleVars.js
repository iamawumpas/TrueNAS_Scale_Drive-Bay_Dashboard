...
export function applyUiVariables(config, hostname) {
    ...
    applyConfigMap(rootStyle, {
        ...
        '--dashboard-alert-border': ui.alerts?.border,
        '--dashboard-alert-bg-start': ui.alerts?.bg_start,
        '--dashboard-alert-bg-end': ui.alerts?.bg_end,
        '--dashboard-alert-text': ui.alerts?.text,
        ...
        '--disk-temp-warn-color': ui.drive_temperature?.warn_color,
        '--disk-temp-hot-color': ui.drive_temperature?.hot_color,
        '--disk-temp-warn-shadow': ui.drive_temperature?.warn_shadow,
        '--disk-temp-hot-shadow': ui.drive_temperature?.hot_shadow,
        ...
        '--menu-action-btn-border': menu.actions?.border,
        '--menu-action-btn-bg-start': menu.actions?.bg_start,
        '--menu-action-btn-bg-end': menu.actions?.bg_end,
        '--menu-action-btn-hover-glow': menu.actions?.hover_glow,
        '--menu-modal-backdrop-bg': menu.modal?.backdrop,
        '--menu-modal-bg-start': menu.modal?.bg_start,
        '--menu-modal-bg-end': menu.modal?.bg_end,
        '--menu-modal-shadow': menu.modal?.shadow,
        '--menu-modal-primary-border': menu.modal?.primary_border,
        '--menu-modal-primary-bg-start': menu.modal?.primary_bg_start,
        '--menu-modal-primary-bg-end': menu.modal?.primary_bg_end,
        '--menu-modal-secondary-border': menu.modal?.secondary_border,
        '--menu-modal-secondary-bg-start': menu.modal?.secondary_bg_start,
        '--menu-modal-secondary-bg-end': menu.modal?.secondary_bg_end,
        '--services-alert-color': menu.services?.alert_color,
        '--services-running-color': menu.services?.running_color,
        '--services-running-border': menu.services?.running_border,
        '--services-stopped-color': menu.services?.stopped_color,
        '--services-stopped-border': menu.services?.stopped_border
    });
